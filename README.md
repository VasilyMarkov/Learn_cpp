...
## Настройка докера
1. Запустите **vscode**. Нажмите **Open Folder** и выберете папку вашего репозитория **Learn cpp**. Перед работой с докером необходимо, чтобы **Docker desktop** был уже запущен. Именно он обеспечивает работу докера в Windows, **vscode** всего лишь предлагает удобный интерфейс.
